  ...
  return (
    <section className="w-full">
      ...
      <div className="border shadow-lg lg:border-none lg:shadow-none rounded-lg p-2">
        <div className="flex flex-col lg:flex-row justify-center items-center overflow-hidden relative min-h-[350px]  max-h-full">
          <div className=" max-w-full lg:max-w-[90%] flex-1   rounded-lg    flex items-center justify-center">
            <div className=" origin-center    scale-110 lg:scale-100 mb-20 lg:mb-0">
              <Suspense>
                <LottieWeb src={"/json/customer-engagement.json"} />
              </Suspense>
            </div>
          </div>
          <div className="w-full lg:max-w-[20%] h-full lg:flex flex-col  lg:space-y-20 z-10 hidden ">
